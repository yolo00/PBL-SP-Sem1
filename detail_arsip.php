                ...
                <div class="rincian-surat">
                    ...
                    <div class="preview-container">
                        ...
                        <div class="preview-section">
                            ...
                            <div class="preview-item"><label>Program Studi:</label> <span><?= $data['prodi'] ?></span>
                            </div>
                            ...
                            <div class="preview-item"><label>Semester:</label> <span>Semester
                                    <?= $data['semester'] ?></span></div>
                            <div class="preview-item"><label>Sesi Kelas:</label> <span><?= $data['sesi_kelas'] ?></span>
                            </div>
                            <div class="preview-item"><label>Status:</label>
                                <span><?= $data['status'] ?? 'Aktif' ?></span>
                            </div>
                        </div>
                        ...
                        <div class="preview-section">
                            ...
                            <div class="preview-item"><label>Tingkat SP:</label> <span><?= $data['tingkat'] ?></span>
                            </div>
                            <div class="preview-item"><label>Tanggal Surat:</label> <span><?= $data['tanggal'] ?></span>
                            </div>
                            <div class="preview-item"><label>Perihal:</label> <span><?= $data['perihal'] ?></span></div>
                            <div class="preview-item"><label>Deskripsi:</label> <span><?= $data['deskripsi'] ?></span>
                            </div>
                ...
                <div class="footer-right">
                    ...
                    <ul class="social-links">
                        ...
                        <li><a href="https://www.youtube.com/@polibatamofficial"><img src="image/icon-youtube.png"
                                    alt="YouTube"></a></li>
                        <li><a href="https://www.polibatam.ac.id"><img src="image/icon-website.png" alt="Website"></a>
                        </li>
                    </ul>
                </div>
            </div>
