          ...
          ?>
                ...
                <div class="profil-info-details">
                    ...
                    <div style="display: flex; align-items: flex-start; justify-content: flex-start; padding-top: 20px; margin-bottom: 30px; gap: 15px; flex-wrap: wrap;">
                        ...
                        <button onclick="openPasswordModal()" style="background: transparent; border: 2px solid #ff6b35; color: #ff6b35; padding: 10px 30px; border-radius: 50px; cursor: pointer; font-weight: 600; font-size: 0.95rem; display: inline-flex; align-items: center; gap: 8px; transition: all 0.3s ease;">
